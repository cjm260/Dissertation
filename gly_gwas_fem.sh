#!/bin/bash
#SBATCH --job-name=gwas_Gly_Fem
#SBATCH --output=/home/cjm260/gwas_files/gwas_results/Gly/gwas_GlyFem_%A_%a.out
#SBATCH --error=/home/cjm260/gwas_files/gwas_results/Gly/gwas_GlyFem_%A_%a.err
#SBATCH --array=1-10
#SBATCH --ntasks=1
...
OUT_PREFIX="${OUT_DIR}/gwas_fem_chr${CHR}"
...
${plink2} --pfile ${PFILE_PREFIX} \
          ...
          --keep /home/cjm260/gwas_files/female_samples.txt \
